...
<body>
    ...
    <div class="container mb-5">
        <div class="card card-insight p-4 bg-white rounded mb-4">
            ...
            <small class="text-muted">💡 點擊右側藍色「開啟原始來源 ↗」按鈕，即可跳轉至官方公告或新聞頁面佐證。</small>
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th style="width: 11%;">近14天聲量</th>
                                <th style="width: 15%;">趨勢標籤</th>
                                <th style="width: 38%;">佐證新聞摘要與對應來源連結 (點擊驗證)</th>
                                    ...
                                    {% for art in item.articles %}
                                        <div class="article-box">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <a href="{{ art.url }}" target="_blank" class="btn btn-sm btn-outline-primary btn-verify ms-2">開啟原始來源 ↗</a>
                                            </div>
                                            <small class="text-secondary d-block">{{ art.summary }}</small>
                                        </div>
                                    {% endfor %}
                                </td>
...
def main():
    ...
    print("Successfully rendered dashboard with direct drug-to-link mapping!")
